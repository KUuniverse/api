...
#### Official Documentation for the Exchange APIs and Streams([简体中文版文档](https://github.com/KUuniverse/api/blob/master/api/zh_cn/api_doc_cn.md))
...
- [Spot API Reference](#b5)
  - [open-api](#b6) ([Api Demo](https://github.com/KUuniverse/api/blob/master/demo/demo.txt))
...
Generate a string to be signed
    -   [open-api Demo](https://github.com/KUuniverse/api/blob/master/demo/demo.java)
